...
toolPrompt = `Goal: Use esta ferramenta para obter o preço atual e o histórico das últimas 24 horas do Ouro (Gold) no jogo Albion Online Context Dump: Dados fornecidos pela tool`
