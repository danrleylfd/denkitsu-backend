...
const TOOLS_DEFINITIONS = [
  ...
  { name: "genshinCharAnalysisTool", title: "Genshin Impact | Análise de Personagem", Icon: "FlagTriangleLeft", description: "Análise de builds de personagens de Genshin Impact a partir de um UID." },
  { name: "genshinCharDetailsTool", title: "Genshin Impact | Detalhes de Personagem", Icon: "FlagTriangleRight", description: "Detalhes de personagens de Genshin Impact a partir de um UID." },
